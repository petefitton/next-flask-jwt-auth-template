...
from typing import Any, Callable, Generic, Iterable, Iterator, Optional, Sequence, TYPE_CHECKING, Tuple, Type, TypeVar, Union, overload
from .session import AsyncSession, AsyncSessionTransaction, _AS, async_sessionmaker
from ... import exc as sa_exc, util
from ...orm.session import Session, _BindArguments, _EntityBindKey, _PKIdentityArgument, _SessionBind
...
from ...orm._typing import OrmExecuteOptionsParameter, _IdentityKeyType, _O
...
@create_proxy_methods(AsyncSession, ":class:`_asyncio.AsyncSession`", ":class:`_asyncio.scoping.async_scoped_session`", classmethods=["close_all", "object_session", "identity_key"], methods=["__contains__", "__iter__", "aclose", "add", "add_all", "begin", "begin_nested", "close", "reset", "commit", "connection", "delete", "execute", "expire", "expire_all", "expunge", "expunge_all", "flush", "get_bind", "is_modified", "invalidate", "merge", "refresh", "rollback", "scalar", "scalars", "get", "get_one", "stream", "stream_scalars"], attributes=["bind", "dirty", "deleted", "new", "identity_map", "is_active", "autoflush", "no_autoflush", "info"], use_intermediate_variable=["get"])
class async_scoped_session(Generic[_AS]):
    ...
    async def execute(self, statement: Executable, params: Optional[_CoreAnyExecuteParams] = ..., *, execution_options: OrmExecuteOptionsParameter = ..., bind_arguments: Optional[_BindArguments] = ..., **kw: Any) -> Result[Any]:
